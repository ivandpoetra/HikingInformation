...
import com.finalproject.hikinginformation.activities.DetailTipsActivity;
...
public class TipsAdapter extends RecyclerView.Adapter<TipsAdapter.ViewHolder> {
    ...
    public TipsAdapter(Context context, List<ModelPeralatan> modelPeralatanList) {
    ...
    @Override
    public void onBindViewHolder(TipsAdapter.ViewHolder holder, final int position) {
        ...
        holder.cvListPeralatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(DetailTipsActivity.DETAIL_PERALATAN, modelPeralatan.get(position));
